...
public class HashCodeTestCase {
    ...
    static {
        try {
            cloneMethod1 = Object.class.getDeclaredMethod("hashCode");
            cloneMethod1.setAccessible(true);
            cloneMethod2 = Object.class.getDeclaredMethod("hashCode");
            cloneMethod2.setAccessible(true);
            cloneMethod3 = DataWithOverride.class.getDeclaredMethod("hashCode");
