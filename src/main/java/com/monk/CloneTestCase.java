...
public class CloneTestCase {
    ...
    static {
        try {
            cloneMethod1 = Object.class.getDeclaredMethod("clone");
            cloneMethod1.setAccessible(true);
            cloneMethod2 = Object.class.getDeclaredMethod("clone");
            cloneMethod2.setAccessible(true);
            cloneMethod3 = DataWithOverride.class.getDeclaredMethod("clone");
